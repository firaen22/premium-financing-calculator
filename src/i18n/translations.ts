export const TRANSLATIONS = {
  en: {
    ...
    chat: {
        ...
        send: "Send",
        emptyState: "Ask about the figures currently on screen. Try \"What happens if HIBOR rises to 6%?\" or \"Which assumptions look risky?\"",
        thinking: "Working…",
  ...
  zh_hk: {
    ...
    chat: {
        ...
        send: "傳送",
        emptyState: "可查詢畫面上現時的數字。試試「若 HIBOR 升至 6% 會怎樣？」或「哪些假設風險較高？」",
        thinking: "處理中…",
