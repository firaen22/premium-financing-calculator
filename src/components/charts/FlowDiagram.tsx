        ...
        <div className="w-full h-full flex justify-center py-4" style={{ minHeight: '400px' }}>
            <svg viewBox="0 0 700 400" className="w-full h-full max-w-[800px]" preserveAspectRatio="xMidYMid meet" style={{ overflow: 'visible' }}>
                ...
                <g transform="translate(0,10)">
                    ...
                    <path d="M 490 320 L 480 320" fill="none" stroke="#c5a059" strokeWidth="2" strokeDasharray="4 4" markerEnd="url(#arrow-gold)" strokeLinecap="round" strokeLinejoin="round" />
                    ...
                    <g filter="url(#shadow)" transform="translate(225, 260)">
                        ...
                        <text x="125" y="100" textAnchor="middle" fill="#c5a059" fontSize="10" fontWeight="bold" style={{ textTransform: 'uppercase' }}>Assets Preserved</text>
                    </g>
